//Downloaded and adapted from: https://github.com/kittykatattack/bump/blob/master/src/bump.js
        ...
        if(sprite.hitArea){
          ...
          if (sprite.gx === undefined) {
            Object.defineProperty(sprite, "gx", {
              get(){return sprite.getGlobalPosition().x + sprite.hitArea.x},
          ...
          if (sprite.gy === undefined) {
            Object.defineProperty(sprite, "gy", {
              get(){return sprite.getGlobalPosition().y + sprite.hitArea.y},
              enumerable: true, configurable: true
            });
          }
          ...
          if (sprite.halfWidth === undefined) {
            Object.defineProperty(sprite, "halfWidth", {
              get(){return sprite.hitArea.width / 2},
              enumerable: true, configurable: true
            });
          }
          ...
          if (sprite.halfHeight === undefined) {
            Object.defineProperty(sprite, "halfHeight", {
              get(){return sprite.hitArea.height / 2},
              enumerable: true, configurable: true
            });
          }
            ...
            Object.defineProperty(sprite, "xAnchorOffset", {
              get(){
                if (sprite.anchor !== undefined) {
                  return sprite.hitArea.width * sprite.anchor.x;
                } else {
                  return 0;
                }
              },
          ...
          if (sprite.yAnchorOffset === undefined) {
            Object.defineProperty(sprite, "yAnchorOffset", {
              get(){
                if (sprite.anchor !== undefined) {
                  return sprite.hitArea.height * sprite.anchor.y;
                } else {
                  return 0;
                }
              },
  ...
  */
  ...
  rectangleCollision(
    ...
    if (global) {
      ...
      vx = (r1.hitArea.x + Math.abs(r1.halfWidth) - r1.xAnchorOffset) - (r2.x + Math.abs(r2.halfWidth) - r2.xAnchorOffset);
      vy = (r1.hitArea.y + Math.abs(r1.halfHeight) - r1.yAnchorOffset) - (r2.y + Math.abs(r2.halfHeight) - r2.yAnchorOffset);
    }
      ...
      if (Math.abs(vy) < combinedHalfHeights) {
        ...
        if (overlapX >= overlapY) {
          ...
          if (vx > 0) {
            collision = "left";
            //Move the rectangle out of the collision
            r1.x = r1.hitArea.x + r1.x + overlapX;
