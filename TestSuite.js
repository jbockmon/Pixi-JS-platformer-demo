(function () {
    ...
    describe('Environment Test:', function(){
       it('Should render to screen given 720 by 480', function(){
        ...
        xit('Should have rederer view object succefully defined', function(){
    ...
    describe('Level Loading', function(){
        ...
        describe('Player Sprite', function(){
            ...
            it('Should have gravity defined', function(){
                expect(playerGravity).not.to.equal(undefined);
            });
            it('Should have jump height defined', function(){
    ...
    describe('Runtime',function(){
        ...
        describe('Number of items', function(){
            it('Shoulnd not exceed 10000 items',function(){
                expect(stage.children.length).to.be.below(10000);
            });
        });
    });
}());